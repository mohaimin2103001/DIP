...
\begin{figure}[H]
    ...
    \caption{Full detailed retinal vessel segmentation pipeline. The diagram includes input data, FOV masking, preprocessing, all three thresholding branches, morphology refinement, ground-truth comparison, skeleton branch evaluation, feature extraction, visual artifacts, CSV outputs, dashboard charts, notebook figures, and final report outputs.}
